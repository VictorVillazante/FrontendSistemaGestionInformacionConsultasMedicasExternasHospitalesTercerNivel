...
export class NotasReferenciaService {
  ...
  obtenerNotasReferenciaPaciente(idPaciente: any) {
    ...
    // return this.http.get<any>(`http://localhost:9092/api/microservicio-notas-referencia/notas-referencia/paciente/${idPaciente}`);
  ...
  obtenerNotasReferencia() {
    ...
    // return this.http.get<any>(`http://localhost:9092/api/microservicio-notas-referencia/notas-referencia`);
  }
